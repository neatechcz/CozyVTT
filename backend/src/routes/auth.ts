 ...
 * Successful logins are not counted, so legitimate re-logins (e.g. the MCP
 * sidecar logging in on every restart) never lock an account out, while
 * password guessing is limited exactly as before.
 */
